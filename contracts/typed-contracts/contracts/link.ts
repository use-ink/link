...
import { ContractAbi } from '../contract-info/link';
import QueryMethods from '../query/link';
import BuildExtrinsicMethods from '../build-extrinsic/link';
import TxSignAndSendMethods from '../tx-sign-and-send/link';
import MixedMethods from '../mixed-methods/link';
import EventsClass from '../events/link';
